 ...
 */
@Component
public class OfficialAccountLimitClient extends OfficialAccountClient {
    @Override
    @ClientRateLimit(resourceName = ClientLimitConstant.OFFICIAL_ACCOUNT_SEND_MESSAGE)
    public void sendMessage(String accessToken, Map<String, Object> paramMap) {
        super.sendMessage(accessToken, paramMap);
    }
}
