...
package com.oszero.deliver.business.server.limit.sms;
 ...
 */
@Component
public class TencentSmsLimitClient extends TencentSmsClient {
    @Override
    @ClientRateLimit(resourceName = ClientLimitConstant.TENCENT_SEND_SMS)
    public void sendSms(SmsApp smsApp, Map<String, Object> paramMap, List<String> users) {
        super.sendSms(smsApp, paramMap, users);
    }
}
