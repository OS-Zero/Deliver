...
package com.oszero.deliver.business.server.limit.mail;
 ...
 */
@Component
public class MailLimitClient extends MailClient {
    @Override
    @ClientRateLimit(resourceName = ClientLimitConstant.SEND_MAIL)
    public void sendMail(MailApp mailApp, Map<String, Object> paramMap, List<String> users) {
        super.sendMail(mailApp, paramMap, users);
    }
}
