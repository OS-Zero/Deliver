...
public class OfficialAccountStreamConsumer implements StreamListener<String, ObjectRecord<String, String>> {
    ...
    public void onMessage(ObjectRecord<String, String> message) {
        streamCommonConsumer.omMessageAck(message, officialAccountHandler);
    }
}
