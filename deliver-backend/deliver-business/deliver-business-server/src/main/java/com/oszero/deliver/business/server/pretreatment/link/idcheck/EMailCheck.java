...
package com.oszero.deliver.business.server.pretreatment.link.idcheck;
 ...
 */
@Service
public class EMailCheck implements MessageLink<SendTaskDto> {
    ...
    public void process(LinkContext<SendTaskDto> context) {
        ...
        for (String email : sendTaskDto.getUsers()) {
            if (!Validator.isEmail(email)) {
                throw new MessageException("消息接收者中有非邮箱地址用户");
            }
        }
    }
}
