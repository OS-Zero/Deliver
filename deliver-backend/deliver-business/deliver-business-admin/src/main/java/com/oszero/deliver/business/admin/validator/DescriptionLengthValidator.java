 ...
 * @version 1.0.0
 */
public class DescriptionLengthValidator implements ConstraintValidator<DescriptionLength, String> {

    @Override
    public boolean isValid(String value, ConstraintValidatorContext context) {
        return StrUtil.isNotBlank(value) && value.length() <= AdminConstant.MAX_DESCRIPTION_LENGTH;
    }
}
