 ...
 * @version 1.0.0
 */
public interface SendTaskService extends IService<SendTask>, Job {
    ...
    void delete(DeleteIdsRequestDto dto) throws SchedulerException;

    void sendRealTimeMessage(SendTaskSendMessageRequestDto dto);
}
