...
import com.oszero.deliver.business.admin.validator.StatusRangeValidator;
...
public @interface StatusRange {
    ...
    int min() default CommonConstant.DISABLE_STATUS;
    int max() default CommonConstant.ENABLE_STATUS;
}
