...
public interface MessageTemplateService extends IService<MessageTemplate> {
    ...
    SearchResponseDto<MessageTemplateSearchResponseDto> search(MessageTemplateSearchRequestDto templateSearchRequestDto);

    void save(MessageTemplateSaveRequestDto dto);

    void update(MessageTemplateUpdateRequestDto dto);

    void updateStatus(MessageTemplateUpdateStatusRequestDto dto);
