...
public interface MQConstant {
    ...
    String FEISHU_TOPIC = "topic_msg_feiShu";
    ...
    String FEISHU_CONSUMER_GROUP = "consumer_group_msg_feiShu";
    ...
    String FEISHU_QUEUE = "queue_msg_feiShu";
    ...
    String FEISHU_KEY_NAME = "key_msg_feiShu";
