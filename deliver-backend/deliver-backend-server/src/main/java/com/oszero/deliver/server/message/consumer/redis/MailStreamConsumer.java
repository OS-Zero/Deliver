...
public class MailStreamConsumer implements StreamListener<String, ObjectRecord<String, String>> {
    ...
    public void onMessage(ObjectRecord<String, String> message) {
        log.info("[MailStreamConsumer 接收到消息] {}", message);
        streamCommonConsumer.omMessageAck(message, mailHandler);
    }
}
