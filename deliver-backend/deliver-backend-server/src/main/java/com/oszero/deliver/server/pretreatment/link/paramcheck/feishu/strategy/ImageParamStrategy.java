...
import com.oszero.deliver.server.message.param.feishu.FeiShuImageParam;
...
@Component(ParamStrategy.FEI_SHU_STRATEGY_BEAN_PRE_NAME + "6-2")
public class ImageParamStrategy implements ParamStrategy {

    @Override
    public void paramCheck(SendTaskDto sendTaskDto) throws Exception {
        Map<String, Object> paramMap = sendTaskDto.getParamMap();
        paramMap.put("msg_type", MessageTypeEnum.FEI_SHU_IMAGE.getMsgType());
        String json = JSONUtil.toJsonStr(paramMap);
        JSONUtil.toBean(json, FeiShuImageParam.class);
