...
const openModel = () => {
	if (props.config.cascader) selectChange(props.config.cascader, props.config.cascader.length - 1)
	open.value = true
}
...
<template>
	<span class="center-modal">
		...
		<a-modal v-model:open="open" :title="config.title" width="650px" :footer="null" @cancel="resetForm">
