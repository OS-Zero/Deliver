...
<template>
	<a-modal v-model:open="openModify" title="修改模板" width="650px" :footer="null" @cancel="handleCancel">
		<a-form ref="templateForm" :model="updateTemp" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol" class="temform">
			<a-form-item ref="templateName" label="模板名" name="templateName" class="tem-item">
				<a-input :maxlength="20" v-model:value="updateTemp.templateName" placeholder="请填写长度在 3 到 20 个字符的模板名" style="width: 70%" />
			</a-form-item>
			...
			<a-form-item :wrapper-col="{ span: 25, offset: 6 }" class="tem-item">
				...
				<a-button style="margin-left: 10px" type="primary" @click="handleOk" :loading="updateiconLoading">确认修改</a-button>
			</a-form-item>
		</a-form>
	</a-modal>
</template>
