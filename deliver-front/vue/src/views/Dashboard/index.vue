				...
				<a-col :span="12">
					<a-card>
						<Echarts
							cardName="消息详情"
							name="chartsMessage"
							:option="chartsMessageOption"></Echarts>
					</a-card>
				</a-col>
				<a-col :span="12">
					<a-card>
						<Echarts
							cardName="模板使用 TOP5"
							name="chartsTemplate"
							:option="chartsTemplateOption"></Echarts>
					</a-card>
				</a-col>
				<a-col :span="12">
					<a-card>
						<Echarts
							cardName="渠道 APP 使用 TOP5"
							name="chartsChannel"
							:option="chartsApplOption"></Echarts>
					</a-card>
				</a-col>
				<a-col :span="12">
					<a-card>
						<Echarts
							cardName="推送用户 TOP5"
							name="chartsAccount"
							:option="chartsUserOption"></Echarts>
					</a-card>
				</a-col>
			</a-row>
		</div>
